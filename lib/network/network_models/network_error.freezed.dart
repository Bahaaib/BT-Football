...
class _$NetworkErrorTearOff {
  ...
  _ResponseError request({required String error}) {
...
mixin _$NetworkError {
  ...
  TResult when<TResult extends Object?>({
    required TResult Function(String error) request,
  ...
  TResult? whenOrNull<TResult extends Object?>({
    TResult Function(String error)? request,
...
abstract class _ResponseError extends NetworkError {
  const factory _ResponseError({required String error}) = _$_ResponseError;
